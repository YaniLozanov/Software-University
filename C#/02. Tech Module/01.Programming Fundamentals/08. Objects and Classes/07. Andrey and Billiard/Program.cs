...
namespace _7.Andrey_and_billiard  
{
    ...
    class Program
    {
        ...
        // He likes to play billiard. Since you are nice guy you want to help him play more of his favorite game.
        ...
        // Then you will receive a list of clients.For every customer, you will receive what to buy and how much.
        // When you receive the command “end of clients” you should display information about every client as described below.
        // After that, print how much total money were spent while Andrey was playing billiard.
